...
![image-20210908000234163]([Vue深入组件-边界情况处理] 访问元素 & 组件.assets/image-20210908000234163.png)
...
1. **要注意使用的所在生命周期**
   ...
   ![image-20210908001206560]([Vue深入组件-边界情况处理] 访问元素 & 组件.assets/image-20210908001206560.png)
...
2. 不要依赖ref实现响应式
   ...
   ![image-20210908002756585]([Vue深入组件-边界情况处理] 访问元素 & 组件.assets/image-20210908002756585.png)
...
![image-20210908010213289]([Vue深入组件-边界情况处理] 访问元素 & 组件.assets/image-20210908010213289.png)
...
![image-20210908010446034]([Vue深入组件-边界情况处理] 访问元素 & 组件.assets/image-20210908010446034.png)
